...
public class CommonMethodstest extends BaseClasstest {
	...
	public void clearcontentoftextbox(By ref) {
		
		driver.findElement(ref).click();
		Actions actions=new Actions(BaseClasstest.getDriver());
		actions.moveToElement(driver.findElement(ref)).click().build().perform();
		actions.keyDown(Keys.CONTROL).build().perform();
		actions.keyDown("A").build().perform();
		actions.keyUp("A").build().perform();
		actions.keyUp(Keys.CONTROL).build().perform();
		actions.keyDown(Keys.BACK_SPACE).build().perform();
		actions.keyUp(Keys.BACK_SPACE).build().perform();
	}
